...
public class TestJaxrsSolrSearchService {
	
	private static final Log LOG = LogFactory.getLog(TestJaxrsSolrSearchService.class);
	private Node node;
	
	@Before
	public void initialize() {
		node = TuscanyRuntime.runComposite("search.jaxrs.composite", "target/classes");
	}
	...
	public void testSearch() throws NoSuchServiceException, IOException {
		...
		String url = "http://tuscany.server.shiyanjun.cn:8080/solrSearchComponent/SolrSearchService/search?";
		String data ="";
